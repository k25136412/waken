...
{/* 1. ダッシュボード（サマリカード群） */}
        <SummaryCards 
          ...
          totalBoxed={totalBoxed}
          deadlineAlertCount={deadlineAlertCount}
          lowStockCount={lowStockCount}
          rawMaterialShortageCount={rawMaterialShortageCount}
          isDeadlineFilterActive={isDeadlineFilterActive}
          setIsDeadlineFilterActive={setIsDeadlineFilterActive}
          isLowStockFilterActive={isLowStockFilterActive}
          setIsLowStockFilterActive={setIsLowStockFilterActive}
          isRawMaterialShortageFilterActive={isRawMaterialShortageFilterActive}
          setIsRawMaterialShortageFilterActive={setIsRawMaterialShortageFilterActive}
        ...
        <ProcessChart 
          ...
          stockByProcess={stockByProcess}
          totalStock={totalStock}
          setViewingProcess={setViewingProcess}
        />
        ...
        <ItemTable 
          ...
          calculateProductStock={calculateProductStock}
          calculateStockByType={calculateStockByType}
