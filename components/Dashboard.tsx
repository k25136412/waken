...
import { Package, Factory, Box, Archive, Clock, AlertTriangle, List, Scissors } from 'lucide-react';
...
export const Dashboard: React.FC<DashboardProps> = ({
  totalStock, totalWIP, totalProduct, totalBoxed,
  deadlineAlertCount, lowStockCount, rawMaterialShortageCount,
  isDeadlineFilterActive, isLowStockFilterActive, isRawMaterialShortageFilterActive,
  setIsDeadlineFilterActive, setIsLowStockFilterActive, setIsRawMaterialShortageFilterActive,
  setViewingStockType
}) => {
  return (
